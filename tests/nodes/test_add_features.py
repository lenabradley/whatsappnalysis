...
def test_run(mocker: MockFixture):
    ...
    # Arrange
    mock_dataset = mocker.patch("whatsappnalysis.nodes.add_features.ChatDataset").return_value
    mock_features = [
        mocker.patch("whatsappnalysis.nodes.add_features._add_overall_sentiment_polarity"),
        mocker.patch("whatsappnalysis.nodes.add_features._add_sentence_tokens"),
        mocker.patch("whatsappnalysis.nodes.add_features._add_token_sentiment_polarities"),
